...
namespace WebApiProducto.Entidades.Seeding
{
         ...
         public static void Seed(ModelBuilder modelBuilder)
        {
           ...
           /* var tablaGeneroPelicula = "GeneroPelicula";
            ...
            // muchos a muchos sin salto
             ...
             var gen1 = new GeneroPelicula()
            {
                 GeneroId = 5,
                 PeliculaId = 2
            };
            var gen2 = new GeneroPelicula()
            {
                GeneroId = 5,
                PeliculaId = 3
            };
            var gen3 = new GeneroPelicula()
            {
                GeneroId = 6,
                PeliculaId = 4
            };

            modelBuilder.Entity<GeneroPelicula>().HasData(gen1, gen2, gen3);
